...
const Footer = () => {
  ...
  return (
    <footer className="bg-[var(--primary)] text-[var(--light)] w-[100wh] overflow-hidden py-12">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="hover:text-[var(--secondary)] transition-colors">ShowCase</a></li>
            <li><a href="#" className="hover:text-[var(--secondary)] transition-colors">Testimonials</a></li>
