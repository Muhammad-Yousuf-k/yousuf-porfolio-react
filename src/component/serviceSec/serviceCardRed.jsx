...
const serviceCardRed = ({ data }) => {
    ...
    return (
        <div style={{ top: topState }} className={` ${data.anima} w-[90%] xl:w-[80%]  bg-[var(--secondary)] gap-5 p-5 flex flex-col lg:flex-row items-center min-h-[350px] max-h-[100vh] rounded sticky`}>
            ...
            <div className="flex gap-3 flex-col justify-center items-center lg:items-start ">
                ...
                <p className='sm:text-base lg:text-xl xl:text-2xl text-center lg:text-start text-white'>{data.para}</p>
            </div>
        </div>
    )
}
