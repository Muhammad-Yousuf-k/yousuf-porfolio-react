...
const navbar = () => {
  return (
    <>
      <nav className='flex sm:flex-wrap justify-around items-center px-3 py-1 h-[10vh] w-full overflow-hidden fixed bg-[var(--light)] z-50'>
        ...
        <div className='hidden md:block'>
          <ul className='flex gap-5 font-medium items-center'>
            ...
            <li className='px-4 py-1'><button className='bg-[var(--secondary)] hover:bg-[var(--primary)] active:scale-95 text-[var(--light)] text-1xl px-6 py-3 rounded'>Hire Me</button></li>
          </ul>
        </div>
      ...
      <div id='pMenu' className="fixed hidden z-40 w-full h-[100vh] bg-[var(--light)]">
